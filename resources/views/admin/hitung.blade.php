            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg mb-6">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200 overflow-y-auto">
                    ...
                    <table class="min-w-full bg-white">
                        <thead>
                            <tr>
                                <th class="py-2">Nama Alternatif</th>
                                @foreach ($kriterias as $kriteria)
                        ...
                        <tbody>
                            @foreach ($alternatifs as $alternatif)
                                <tr>
                                    <td class="py-2 text-center">{{ $alternatif->nama_alternative }}</td>
                                    @foreach ($kriterias as $kriteria)
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody>
                            @foreach ($ValueSAW as $id => $nilaiSAW)
                                <tr>
                                    <td class="py-2 text-center">{{ $alternatifs->find($id)->nama_alternative }}</td>
